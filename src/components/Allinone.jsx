...
const StudentManager = () => {
  const { student, setStudent, message, setMessage } = useStudentContext(); // Use context
  const [studentId, setStudentId] = useState('');

  // useEffect to load initial data if needed
  useEffect(() => {
    if (studentId) {
      handleFetch();
    }
  ...
  }, [studentId, setStudent, setMessage]); // depend on studentId
